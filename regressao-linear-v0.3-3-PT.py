...
#######################################################################################
criptomoeda_df = get_bars(criptomoeda)
criptomoeda_fechamento = criptomoeda_df['c'].astype('float').values
criptomoeda_close = criptomoeda_df['c'].astype('float')
criptomoeda_abertura = criptomoeda_df['o'].astype('float').values
criptomoeda_num_trades = criptomoeda_df['num_trades'].astype('float')
criptomoeda_maxima = criptomoeda_df['h'].astype('float')
criptomoeda_minima = criptomoeda_df['l'].astype('float')
criptomoeda_volume = criptomoeda_df['v'].astype('float')
criptomoeda_datas_fechamento = criptomoeda_df['close_time'].astype('float')
criptomoeda_datas_abertura = criptomoeda_df['open_time'].astype('float')
taker_base_vol = criptomoeda_df['taker_base_vol'].astype('float')
taker_quote_vol = criptomoeda_df['taker_quote_vol'].astype('float')
...
#######################################################################################
criptomoeda_fechamento_mediamovel = criptomoeda_df['c'].rolling(30).mean()
#######################################################################################
# Média movel de 30 dias do Fechamento
#######################################################################################
criptomoeda_fechamento_mediamovel100 = criptomoeda_df['c'].rolling(100).mean()
#######################################################################################
...
for i in tqdm((criptomoeda_y_pred), desc =" DataCrypto Analytics criando previsões"): 
    sleep(.02) 
#######################################################################################
#========   The coefficients
#######################################################################################
