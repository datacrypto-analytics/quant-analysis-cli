...
moeda_cotacao = input('\nDigite a moeda cotação listada na ALPHA VANTAGE (Ex: EUR, USD, JPY): ')
###############################################################################################################
...
print(par)
interval = input('Digite o Timeframe (Exemplo: 5min, 15min, 30min, 60min): ')
...
#######################################################################################
forex_fechamento_mediamovel = df['close'].rolling(12).mean()
#######################################################################################
# Média movel de 30 dias do Fechamento
#######################################################################################
forex_fechamento_mediamovel100 = df['close'].rolling(30).mean()
#######################################################################################
...
plt.title('DataCrypto Analytics (@DataCryptoML) - %s' %(par))
